...
CREATE TABLE IF NOT EXISTS ews_materials (
  ...
  location VARCHAR(50), -- INTERIOR/EXTERIOR
  material_type VARCHAR(255),
  manufacturer VARCHAR(255) NOT NULL,
  product_name VARCHAR(500) NOT NULL,
  epd_number VARCHAR(100),
  dimension VARCHAR(50),
  gwp DECIMAL(10,2), -- Global Warming Potential
  gwp_units VARCHAR(50), -- e.g., 'kg CO2 eq'
  declared_unit VARCHAR(100),
  msf_factor DECIMAL(10,3), -- MSF (Material Safety Factor)
