      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            <Link href="/search" className="text-slate-300 hover:text-white transition-colors">Product Search</Link>
            <Link href="/suppliers" className="text-slate-300 hover:text-white transition-colors">Suppliers</Link>
