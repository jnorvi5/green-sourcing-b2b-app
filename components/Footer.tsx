        ...
        <div className="grid md:grid-cols-5 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="/download-plugin" className="hover:text-primary transition-colors">Download Plugin</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="/docs" className="hover:text-primary transition-colors">Plugin Docs</Link></li>
