                ...
                <div className="grid md:grid-cols-5 gap-8">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <a
                                href="https://youtube.com/@greenchainz"
                                target="_blank"
                                rel="noopener noreferrer"
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link to="/sustainability" className="text-slate-400 hover:text-emerald-400 transition-colors text-sm">Sustainability</Link></li>
                            <li><Link to="/investors" className="text-slate-400 hover:text-amber-400 transition-colors text-sm">Investors</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link to="/network" className="text-slate-400 hover:text-blue-400 transition-colors text-sm">Supplier Network</Link></li>
                        </ul>
                    </div>
