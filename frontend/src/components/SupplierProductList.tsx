...
export default function SupplierProductList({
  ...
  if (loading) {
    return (
      <div className="text-center text-green-primary">Loading products...</div>
    );
  }
  ...
  return (
    <div className="card">
      <div className="flex justify-between items-center mb-4 border-b-2 border-green-light pb-2">
        <h2 className="text-2xl font-semibold text-green-secondary">
          My Product Catalog
        </h2>
        <button
      ...
      {showAddForm && (
        <form
          ...
          className="mb-6 p-4 bg-green-light/10 rounded border border-green-light"
        >
          ...
          {/* Materials Section */}
          <div className="mb-4">
            <h4 className="text-md font-semibold text-neutral-dark mb-2">
              ...
              <div className="mb-3 space-y-2">
                {formData.materials.map((material, index) => (
                  ...
                  >
                    ...
                    {material.isRecycled && (
                      <span className="text-xs bg-green-accent/20 text-green-primary px-2 py-1 rounded">
                        Recycled
                      </span>
                    )}
                    {material.isBioBased && (
        ...
        <div className="space-y-4">
          {products.map((product) => (
            <div
              ...
              className="p-4 border border-neutral-light rounded hover:bg-green-light/5 transition-colors"
            >
              <div className="flex justify-between items-start mb-2">
                <div>
                  ...
                  {product.categoryName && (
                    <span className="text-xs bg-neutral-light text-neutral-dark px-2 py-1 rounded">
                      {product.categoryName}
                    </span>
                  )}
                </div>
                ...
                <div className="mt-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {product.materials.map((material, idx) => (
                      <div
                        key={idx}
                        className="text-xs bg-green-light/20 px-2 py-1 rounded border border-green-light"
                      >
                        {material.materialName}
