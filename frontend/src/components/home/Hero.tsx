        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-left">
            <h1 className="max-w-2xl mb-6 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
              Sourcing Sustainable Materials <span className="text-gradient">Just Got Verified.</span>
            </h1>
            ...
            <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center lg:justify-start sm:space-y-0 sm:space-x-4">
              <Link href="/sourcing" className="btn-primary inline-flex items-center justify-center text-base text-center">
                Start Sourcing
                <svg className="w-5 h-5 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
              </Link>
              <Link href="/suppliers" className="btn-secondary inline-flex items-center justify-center text-base text-center border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                List Your Products
              </Link>
            </div>
          </div>
