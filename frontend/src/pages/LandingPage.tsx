        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 relative">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-slate-300 mb-12 max-w-2xl mx-auto leading-relaxed">
              The global trust layer for sustainable commerce. Connect verified
              suppliers with forward-thinking architects. Zero greenwashing.
              Total transparency.
            </p>
            ...
            {[
              {
                ...
                description:
                  'Filter by carbon footprint, certifications, lead times, and 50+ sustainability metrics',
              },
              {
                icon: '🎯',
                title: 'Send RFQs Instantly',
                description:
                  'Message verified suppliers directly. Collaborate on projects. Track proposals in real-time.',
              },
              {
                icon: '🏆',
                title: 'Verified Suppliers',
                description:
                  'Every product backed by third-party certifications. FSC, B Corp, Cradle to Cradle, and more.',
              },
            ].map((feature, i) => (
              <div
                key={i}
                className="p-6 rounded-2xl bg-slate-800/50 border border-slate-700/50 hover:border-sky-500/50 transition-colors"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              {[
                {
                  step: '01',
                  title: 'Sign Up & Complete Survey',
                  desc: 'Tell us about your sustainability goals and material needs',
                },
                {
                  step: '02',
                  title: 'Search Our Network',
                  desc: 'Browse verified suppliers with real-time data and certifications',
                },
                {
                  step: '03',
                  title: 'Compare & Request Quotes',
                  desc: 'Side-by-side comparison tools and instant RFQ workflows',
                },
                {
                  step: '04',
                  title: 'Close Deals Faster',
                  desc: 'Message board, project tracking, and transparent pricing',
                },
              ].map((item, i) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={i}
                className="flex items-center justify-center p-6 rounded-xl bg-slate-800/30 border border-slate-700/30"
              >
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a
                    href="mailto:hello@greenchainz.com"
                    className="text-slate-400 hover:text-sky-400 transition-colors text-sm"
                  >
                    Support
                  </a>
