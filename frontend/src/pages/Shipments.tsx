                            ...
                            <tbody className="divide-y">
                                {analytics.carrierPerformance.map((carrier) => (
                                    <tr key={carrier.carrier}>
                                        ...
                                        <td className="py-3">
                                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${carrier.onTimeRate >= 95 ? 'bg-green-100 text-green-800' :
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    ...
                    <div className="flex gap-4 mt-6">
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg font-medium transition-colors ${activeTab === 'shipments'
