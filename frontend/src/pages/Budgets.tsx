                    ...
                    {alerts.map((alert, index) => (
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <span className={`px-2 py-1 rounded-full text-xs font-medium ${alert.type === 'critical' ? 'bg-red-200 text-red-800' : 'bg-yellow-200 text-yellow-800'
                                    }`}>
                    ...
                    >
                        ...
                        <div className="grid grid-cols-4 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <p className={`text-lg font-semibold ${utilization >= 90 ? 'text-red-600' :
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    ...
                    <div className="flex gap-4 mt-6">
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg font-medium transition-colors ${activeTab === 'budgets'
                                    ? 'bg-green-100 text-green-700'
                                    : 'text-gray-600 hover:bg-gray-100'
                                }`}
                        >
