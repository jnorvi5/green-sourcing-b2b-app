                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {selectedQualification.certifications.map((cert, index) => (
                                    <div
                                        key={index}
                                        className={`p-4 rounded-lg border ${cert.status === 'expired' ? 'border-red-200 bg-red-50' :
                                    ...
                                    >
                                        <div className="flex items-start justify-between">
                                            ...
                                            <Award className={`w-5 h-5 ${cert.status === 'expired' ? 'text-red-500' :
                        ...
                        {Object.entries(dashboard.byTier).map(([tier, count]) => {
                            ...
                            return (
                                <div key={tier}>
                                    ...
                                    <div className="w-full bg-gray-200 rounded-full h-2">
                                        <div
                                            className={`h-2 rounded-full ${tier === 'preferred' ? 'bg-purple-500' :
                        ...
                        {qualification.certifications.length > 0 && (
                            <div className="flex flex-wrap gap-2 mt-4 pt-4 border-t">
                                {qualification.certifications.slice(0, 4).map((cert, index) => (
                                    <span
                                        key={index}
                                        className={`inline-flex items-center gap-1 px-2 py-1 rounded text-xs ${cert.status === 'expired' ? 'bg-red-100 text-red-700' :
                        ...
                        {expiringCerts.length > 0 ? (
                            expiringCerts.map((cert, index) => (
                                <div key={index} className="p-4 flex items-center justify-between hover:bg-gray-50">
                                    ...
                                    <div className="text-right">
                                        <p className={`text-sm font-medium ${cert.status === 'expired' ? 'text-red-600' : 'text-yellow-600'
                                            }`}>
                        ...
                        {upcomingRequalifications.length > 0 ? (
                            upcomingRequalifications.map((q) => (
                                <div key={q._id} className="p-4 flex items-center justify-between hover:bg-gray-50">
                                    ...
                                    <div className="text-right">
                                        <p className={`text-sm font-medium ${getDaysUntil(q.requalificationDue!) <= 30 ? 'text-red-600' : 'text-yellow-600'
                                            }`}>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    ...
                    <div className="flex gap-4 mt-6">
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg font-medium transition-colors ${activeTab === 'alerts'
                                    ? 'bg-green-100 text-green-700'
                                    : 'text-gray-600 hover:bg-gray-100'
                                }`}
                        >
