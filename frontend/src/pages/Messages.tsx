                            ...
                            {filteredConversations.length === 0 ? (
                                ...
                                filteredConversations.map((conv) => (
                                    <div
                                        ...
                                        className={`p-4 border-b border-gray-700 cursor-pointer transition-colors ${selectedConversation?.id === conv.id
                                                ? 'bg-gray-700/50'
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                >
                                                        ...
                                                        <div className="mt-2 space-y-1">
                                                            {message.attachments.map((att, i) => (
                                                                <a
                                                                    key={i}
                                                                    href={att.url}
                                                                    className={`flex items-center gap-2 text-xs ${isOwn ? 'text-emerald-200' : 'text-gray-400'
                                                                        } hover:underline`}
                                                                >
                                                    ...
                                                    <div
                                                        className={`flex items-center justify-end gap-1 mt-1 text-xs ${isOwn ? 'text-emerald-200' : 'text-gray-500'
                                                            }`}
                                                    >
