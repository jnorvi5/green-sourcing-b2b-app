    ...
    const renderToggle = (
        ...
        <div className="flex items-center justify-between py-3">
            ...
            <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${enabled ? 'bg-emerald-600' : 'bg-gray-600'
                    }`}
            >
                <span
                                        ...
                                        <div className="flex gap-3">
                                            {[
                                                ...
                                                <button
                                                    ...
                                                    className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-lg border transition-colors ${theme === option.value
                                        ...
                                        <div className="flex gap-3">
                                            {[
                                                ...
                                                <button
                                                    ...
                                                    className={`flex-1 px-4 py-3 rounded-lg border transition-colors ${units === option.value
                                                            ? 'border-emerald-500 bg-emerald-900/20'
                                                            : 'border-gray-700 hover:border-gray-600'
                                                        }`}
                                                >
