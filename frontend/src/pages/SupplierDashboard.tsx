...
export function SupplierDashboard() {
  const [activeTab, setActiveTab] = useState<'products' | 'analytics' | 'rfqs'>(
    'products'
  );
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <nav className="hidden md:flex items-center gap-4">
                <a
                  href="#"
                  className="px-3 py-2 rounded-lg bg-sky-500/10 text-sky-400 font-medium"
                >
                  Dashboard
                </a>
                <a
          ...
          {[
            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                <span
                  className={`text-sm font-medium ${stat.change.startsWith('+') ? 'text-green-400' : 'text-slate-500'}`}
                >
                  {stat.change}
                </span>
              </div>
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <h3 className="text-xl font-bold text-white mb-2">
                🎯 Join Group Certification Program
              </h3>
              <p className="text-slate-300 mb-4">
                Save 40% on FSC and B Corp certifications by joining our group
                processing program. Next batch closes in 14 days.
              </p>
              ...
              {[
                {
                  ...
                  product: 'Bamboo Panels',
                  date: '2 hours ago',
                  status: 'New',
                },
                {
                  company: 'Green Design Co',
                ...
                {
                  company: 'EcoBuilders LLC',
                  project: 'School Building',
                  product: 'Bio Insulation',
                  date: '3 days ago',
