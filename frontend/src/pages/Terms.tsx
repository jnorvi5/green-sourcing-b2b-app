      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          <section className="text-slate-300">
            ...
            <p>
              By accessing and using GreenChainz, you accept and agree to be
          ...
          <section className="text-slate-300">
            ...
            <p className="mb-4">
              GreenChainz provides a B2B marketplace platform connecting
              architects and contractors with verified sustainable building
              material suppliers. Our services include:
            </p>
          ...
          <section className="text-slate-300">
            ...
            <p>
              While we verify supplier certifications and sustainability data to
              the best of our ability, GreenChainz is not liable for
              inaccuracies or changes in supplier status. Users should conduct
          ...
          <section className="text-slate-300">
            ...
            <p>
              GreenChainz provides the platform "as is" without warranties. We
              are not liable for indirect damages, lost profits, or third-party
          ...
          <section className="text-slate-300">
            ...
            <p>
              ...
              <a
                href="mailto:legal@greenchainz.com"
