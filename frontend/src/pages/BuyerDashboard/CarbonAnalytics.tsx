                                            ...
                                            return (
                                                <tr key={project.id} className="border-b border-border hover:bg-muted/50">
                                                    ...
                                                    <td className="text-center py-4 px-2">
                                                        <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${project.status === 'on-track'
                                ...
                                {recommendations.map(rec => (
                                    ...
                                    >
                                        <div className="flex items-start justify-between">
                                            ...
                                            <span className={`text-xs px-2 py-0.5 rounded ${rec.difficulty === 'easy'
                                                    ? 'bg-green-100 text-green-800'
