  ...
  const messages = [
    {
      ...
      avatar: '👩‍💼',
      content:
        'Has anyone worked with cross-laminated timber (CLT) for mid-rise buildings? Looking for supplier recommendations with FSC certification.',
    ...
    },
    {
      ...
      avatar: '🏭',
      content:
        '🎉 Excited to announce: We just achieved B Corp certification! All our recycled steel products now carry dual FSC + B Corp credentials. AMA about the process!',
    ...
    },
    {
      ...
      avatar: '🌱',
      content:
        "Question for the group: What's the biggest barrier to adopting circular materials in your projects? Cost? Availability? Certification complexity?",
      timestamp: '1 day ago',
      replies: 56,
      likes: 43,
    },
          ...
          <div className="lg:col-span-3">
            <div className="mb-6 p-6 rounded-2xl bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/30">
              <h2 className="text-xl font-bold text-white mb-2">
                💡 Welcome to the GreenChainz Network
              </h2>
              <p className="text-slate-300 text-sm">
                Connect with architects, suppliers, and sustainability experts.
                Share insights, ask questions, and collaborate on building a
                greener future.
              </p>
            </div>
            ...
            <div className="space-y-4">
              {messages.map((message) => (
                <div
                  key={message.id}
                  className={`p-6 rounded-2xl bg-slate-900 border transition-colors ${
                    message.isPinned
