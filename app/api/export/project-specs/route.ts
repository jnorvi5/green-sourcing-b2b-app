/**
 * Project Specs CSV Export Endpoint
 * GET /api/export/project-specs?productIds=1,2,3
 * 
 * Generates a CSV file compatible with Revit and Excel import
 */

import { NextResponse } from 'next/server';
import { generateCsv, generateProjectSpecFilename } from '../../../../lib/export/csv-generator';
...
export async function GET(request: Request): Promise<NextResponse> {
  try {
    ...
    const filename = generateProjectSpecFilename();
