...
function ArchitectDashboardInner() {
  ...
  const [rfqTargetProduct, setRfqTargetProduct] = useState<Product | null>(
    null
  );
  ...
  const openRfqModal = (product: Product) => {
    ...
    setRfqMessage(
      `I am interested in ${product.name}. Please provide a quote for the following project.`
    );
      ...
      setSentRFQs((prev) => [
        {
          ...
          profiles: {
            company_name:
              rfqTargetProduct.supplier?.company_name || "Mock Supplier",
          },
        },
        ...prev,
      ]);
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-black text-white pb-20">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-4 py-2 bg-gray-800 hover:bg-red-900/50 rounded-lg transition-colors border border-gray-700 hover:border-red-800"
            >
              Logout
            </button>
          </div>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">View all requests</p>
              </div>
            </div>
          </Link>
        </div>
            ...
            return (
              <div
                ...
                className={`bg-gray-900 border ${
                  isSelected ? "border-teal-500" : "border-gray-800"
                } rounded-xl overflow-hidden hover:border-gray-600 transition-colors flex flex-col`}
              >
                <div className="h-48 bg-gray-800 relative">
                  ...
                  {product.gwp !== undefined && (
                    <div className="absolute top-2 right-2 bg-black/70 backdrop-blur text-white text-xs px-2 py-1 rounded flex items-center gap-1 border border-white/10">
                      <FaLeaf className="text-emerald-400" /> {product.gwp} kg
                      CO2e
                    </div>
                  )}
                </div>
            ...
            <div className="bg-gray-900 border border-gray-700 rounded-2xl w-full max-w-5xl h-[80vh] flex flex-col overflow-hidden shadow-2xl">
              <div className="p-6 border-b border-gray-800 flex justify-between items-center bg-gray-850">
                <h2 className="text-2xl font-bold text-white flex items-center gap-2">
                  <FaBalanceScale className="text-teal-400" /> Product
                  Comparison
                </h2>
                <button
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-300">
                            {product.supplier?.location || "Unknown"}
                          </p>
                        </div>
              ...
              <div className="mb-6 bg-gray-800 p-4 rounded-lg flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-white">
                    {rfqTargetProduct.name}
                  </h4>
                  <p className="text-sm text-teal-400">
                    {rfqTargetProduct.supplier?.company_name}
                  </p>
                </div>
              </div>
      ...
      {user?.id && <AssistantChat userId={user.id} />}
    </main>
  );
}
