...
export default function LeadDetail({
  ...
  return (
    <div className="bg-gray-800/50 rounded-xl p-6">
      ...
      {/* Context */}
      {lead.context &&
        (lead.context.companyDescription || lead.context.customHook) && (
          <div className="mb-6">
            ...
            <div className="bg-gray-900/50 rounded-lg p-4 space-y-2">
              ...
              {lead.context.customHook && (
                <p className="text-emerald-400 text-sm">
                  Hook: {lead.context.customHook}
                </p>
              )}
              {lead.context.certifications &&
                lead.context.certifications.length > 0 && (
      ...
      <div className="flex items-center justify-between mb-6 p-4 bg-gray-900/50 rounded-lg">
        ...
        <button
          ...
          aria-label={
            autoFollowUp ? "Disable auto follow-up" : "Enable auto follow-up"
          }
