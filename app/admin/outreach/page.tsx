              ...
              <form onSubmit={handleCreateLead} className="p-4 space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e: Record<string, unknown>) => setCreateForm({ ...createForm, companyName: e.target.value })}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e: Record<string, unknown>) => setCreateForm({ ...createForm, contactName: e.target.value })}
                      className="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-4 py-2 text-gray-200 focus:outline-none focus:border-emerald-500"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e: Record<string, unknown>) => setCreateForm({ ...createForm, email: e.target.value })}
                      className="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-4 py-2 text-gray-200 focus:outline-none focus:border-emerald-500"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e: Record<string, unknown>) => setCreateForm({ ...createForm, role: e.target.value })}
                      className="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-4 py-2 text-gray-200 focus:outline-none focus:border-emerald-500"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e: Record<string, unknown>) => setCreateForm({ ...createForm, phone: e.target.value })}
                      className="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-4 py-2 text-gray-200 focus:outline-none focus:border-emerald-500"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e: Record<string, unknown>) => setCreateForm({ ...createForm, website: e.target.value })}
                      className="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-4 py-2 text-gray-200 focus:outline-none focus:border-emerald-500"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e: Record<string, unknown>) => setCreateForm({ ...createForm, leadType: e.target.value as LeadType })}
                      className="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-4 py-2 text-gray-200 focus:outline-none focus:border-emerald-500"
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e: Record<string, unknown>) => setCreateForm({ ...createForm, source: e.target.value })}
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e: Record<string, unknown>) => setCreateForm({ ...createForm, priority: e.target.value as LeadPriority })}
                      className="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-4 py-2 text-gray-200 focus:outline-none focus:border-emerald-500"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e: Record<string, unknown>) => setCreateForm({ ...createForm, companyDescription: e.target.value })}
                    rows={2}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e: Record<string, unknown>) => setCreateForm({ ...createForm, customHook: e.target.value })}
                    rows={2}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e: Record<string, unknown>) => setCreateForm({ ...createForm, notes: e.target.value })}
                    rows={2}
